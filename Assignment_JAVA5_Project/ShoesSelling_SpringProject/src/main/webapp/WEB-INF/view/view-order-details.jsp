        ...
        <main>
            ...
            <section style="background-color: #eee;">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        <th>#</th>
                        <th>OrderDetail Code</th>
                        <th>OrderDetail Product Code</th>
                        <th>OrderDetail Product Name</th>
                        <th>OrderDetail Product Quantity</th>
                        <th>OrderDetail Product Price</th>
                        <th>Order Status</th>
                        <th>Action</th>
                    </tr>
                    </thead>
                    ...
                    <c:forEach items="${orderDetailList}" var="o" varStatus="status">
                        <tr>
                            <td>${status.index + 1}</td>
                            <td><img src="${o.productDetail.image}" height="100px" width="100px"></td>
                            <td>${o.orders.ordersCode}</td>
                            <td>${o.productDetail.product.productCode}</td>
                            <td>${o.productDetail.product.productName} </td>
                            <td>${o.quantity}</td>
                            <td>${o.unitPrice}</td>
                            <td>
                                <button class="btn btn-outline-success"><a style="text-decoration: none" href="">Beta button</a></button>
                                <button class="btn btn-outline-success"><a style="text-decoration: none">Beta</a></button>
                            </td>
                        </tr>
                    </c:forEach>
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <button class="btn btn-outline-Danger"><a style="text-decoration: none" href="">Print</a></button>
